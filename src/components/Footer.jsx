...
const socials = [
  {
    icon: FacebookIcon,
    label: 'Facebook',
    href: 'https://www.facebook.com/youngzoneindia'
  },
  {
    icon: InstagramIcon,
    label: 'Instagram',
    href: 'https://www.instagram.com/youngzoneindia'
  },
  {
    icon: WhatsAppIcon,
    label: 'WhatsApp',
    href: 'https://wa.me/c/919011256256'
  },
  {
    icon: LinkedInIcon,
    label: 'LinkedIn',
    href: 'https://in.linkedin.com/company/youngzoneindia'
  }
]
